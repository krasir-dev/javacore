...
public class AccuWeatherProvider implements WeatherProvider {
    ...
    @Override
    public void getWeather(Periods periods) throws IOException, JsonProcessingException {
        ...
        if (periods.equals(Periods.NOW)) {
            ...
            //List<WeatherResponse> carList = objectMapper.readValue(response.body().string(), new TypeReference<List<WeatherResponse>>() {});
           //System.out.println(carList);
            //System.out.println(response.body().string());

            /*WeatherResponse[] weatherResponses = objectMapper.readValue(jsonResponse, WeatherResponse[].class);
            for (WeatherResponse str : weatherResponses) {
                str.toString();
